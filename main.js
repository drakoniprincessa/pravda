(function () {
    ...
    if (container.getBoundingClientRect().width < 500) {
        alert('Открой страницу на большом экране с компа')
        container.innerHTML = 'Открой страницу на большом экране с компа';
        return;
    }
